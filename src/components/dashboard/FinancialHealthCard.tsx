...
export function FinancialHealthCard({
  ...
  const getRecommendation = () => {
    if (savingsRate >= 20)
      return "Excelente manejo. Considera invertir tu excedente.";
    if (savingsRate >= 10)
      return "Buen progreso. Intenta incrementar tu tasa de ahorro al 20%.";
    if (savingsRate > 0)
      return "Revisa gastos en entretenimiento y servicios para mejorar.";
